...
Viewer::Viewer(Config configuration_, int *argc, char **argv) noexcept
...
void Viewer::rotateUp() noexcept { --rotx; }

void Viewer::rotateDown() noexcept { ++rotx; }

void Viewer::rotateLeft() noexcept { --roty; }

void Viewer::rotateRight() noexcept { ++roty; }

void Viewer::scaleUp() noexcept { windowScale += .1f; }
