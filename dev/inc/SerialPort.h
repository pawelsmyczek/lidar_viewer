...
public:
  ...
  /// @brief configures serial port, sets 8N1 type of communication TODO make it
  /// configurable
  /// @param baudRate serial port baud rate, can be of any type, but takes into
  /// account regular types defined in termios-baud.h
